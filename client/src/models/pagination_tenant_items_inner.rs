...
pub struct PaginationTenantItemsInner {
...
impl PaginationTenantItemsInner {
    pub fn new(algorithm: String, client_id: uuid::Uuid, created_at: String, expires_in_seconds: i64, id: i64, issuer: String, oauth2_providers: Vec<models::TenantOAuth2Provider>, refresh_expires_in_seconds: i64, updated_at: String) -> PaginationTenantItemsInner {
        PaginationTenantItemsInner {
            algorithm,
            audience: None,
            client_id,
            created_at,
