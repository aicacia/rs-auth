...
pub struct PaginationUserItemsInner {
    #[serde(rename = "active")]
    pub active: bool,
...
impl PaginationUserItemsInner {
    pub fn new(active: bool, created_at: String, emails: Vec<models::UserEmail>, id: i64, info: models::UserInfo, mfa_types: Vec<models::UserMfaType>, oauth2_providers: Vec<models::UserOAuth2Provider>, phone_numbers: Vec<models::UserPhoneNumber>, updated_at: String, username: String) -> PaginationUserItemsInner {
        PaginationUserItemsInner {
            active,
            config: None,
            created_at,
            email: None,
